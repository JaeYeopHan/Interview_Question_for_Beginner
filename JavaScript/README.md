...
## Arrow Function
화살표 함수 표현식은 기존의 function 표현방식보다 간결하게 함수를 표현할 수 있다. 화살표 함수는 항상 익명이며, 자신의 this, arguments, super 또는 new.target을 바인딩하지 않는다. 그래서 생성자로는 사용할 수 없다.
...
var p = new Person(
```
일반 함수에서는 모든 새로운 함수는 자신의 this값을 정의합니다. 하지만 화살표 함수 this는 Person의 this와 동일한 값을 갖습니다.
